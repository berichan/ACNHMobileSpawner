...
public class UnitItemSpriteHelper
{
    ...
    private const string imgpointerin = "BeriPointer_unit";
    private const ushort defaultitemimg = 2;

    private static string fileroot { get { return Application.persistentDataPath + Path.DirectorySeparatorChar + "UnitItem"; } }
